...
limited_data <- map_dfr(5:12, create_hits_distibution, deck_size = 40)
```
...
```{r create_constructed_data}
constructed_data <- map_dfr(12:19, create_hits_distibution, deck_size = 60)
```
